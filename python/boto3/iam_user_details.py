...
iam_user = input(
    "Enter you IAM User name to get datials like ID,ARN,CREATION DATE: ")
...
try:
    print("IAM User: EC2_S3_IAM Detatils\nUser Name: {}\nUser Id: {}\nUser ARN: {}\nUser Creation Date: {}".format(
        req_iam_user.user_name, req_iam_user.user_id, req_iam_user.arn, req_iam_user.create_date))
