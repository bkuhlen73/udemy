...
def main():
    ...
    try:
        ...
        if e.response['Error']['Code'] == "EntityAlreadyExists":
            print("Already Iam User with {} does exist".format(Iam_user_name))
            sys.exit(0)
        else:
    ...
    iam_client.create_login_profile(
        UserName=Iam_user_name, Password=passwrd, PasswordResetRequired=False)
